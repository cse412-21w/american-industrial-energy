...
function drawBarVegaLite() {
  ...
  vl.markBar({
    filled: true,
    color: 'black'
  }).data(co2ByFuelArray).encode(vl.x().fieldN('Fuel').sort('none'), vl.y().fieldQ('CO2'), vl.tooltip('Tooltip')).width(500).height(300).render().then(function (viewElement) {
...
//# sourceMappingURL=https://cse412-21w.github.io/american-industrial-energy/co2_by_fuel.d01a16c6.js.map